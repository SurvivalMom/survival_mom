# MODE 4：ループ動画化（CapCut手順）木曜「一気に戻そうとしていませんか？」

対象素材：content/mode3/2026-08-13_rizumu-3step-infographic.md のnanobanana画像（テキスト込み）
...
```
JP: 夏休み明けまでに、生活リズムを一気に戻そうとして疲れているお母さんへ。3つのステップにまとめました。
Romaji: Natsuyasumi ake made ni, seikatsu rizumu wo ikki ni modosou to shite tsukarete iru okaasan e. Mittsu no step ni matomemashita.
```
